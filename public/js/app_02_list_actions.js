...
async function getTrelloOpenList() {
...
actions = [];
    ...
    try {
        ...
        let url = 'https://api.trello.com/1/lists/5d236c62097c7c4691df65ff/cards?key=8ec6c3e51ab6d8dd92e69f3e23582eff&token=07843a91cede6b50196f92983c9be337105fd5336071710ea779bf2f70063f68';
        ...
        let html = '';
            try{
                ...
                cards.forEach(card => {
                    ...
                    let html = `<div class="alert alert-primary text-center"><h5>Actualmente hay ${c}  tarjetas en la lista de acciones pendientes </h5></div>`;
