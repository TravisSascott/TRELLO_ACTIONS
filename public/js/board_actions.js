...
async function getActionsOnBoard() {
  ...
  const board = "5d1f2656d29b04175a69af05"; // TABLERO RECLAMACIONES
  try {
    actionChecklists = [];
    checkItemsList = [];
  ...
  try {
    let counter_all = 0;
    let counter_incomplete = 0;
    let i = 0;
    for (i = 0; i < actionChecklists.length; i++) {
      let url =
        "https://api.trello.com/1/checklists/" +
        actionChecklists[i].id +
        "/checkitems?key=8ec6c3e51ab6d8dd92e69f3e23582eff&token=07843a91cede6b50196f92983c9be337105fd5336071710ea779bf2f70063f68";
      let res = await fetch(url);
