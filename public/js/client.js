      ...
      return {
        ...
        callback: function(t) {
          ...
          if (t.memberCanWriteToModel("card")) {
            ...
            console.log(
              "Oh no! You don't have permission to add attachments to this card."
            );
              ...
              items: [
                ...
                },
                {
                  ...
                  callback: function(t, opts) {
                    return t.navigate({
                      url:
                        "https://trello.com/b/K3k1CNLD/holiday-meal-planning?menu=filter&filter=label:Sides"
                    });
                  }
                },
                {
                  ...
                  callback: function(t, opts) {
                    return t.navigate({
                      url: "https://trello.com/c/3Zb4GlkC/2-card"
                    });
                  }
                }
              ]
